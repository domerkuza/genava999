...
<head>
    ...
    <title>Hackathon Platform - Projects Management</title>
    <style>
                ...
                <tbody>
                    <?php while ($stagiaires = $pdostmt1->fetch(PDO::FETCH_ASSOC)): ?>
                        <tr>
                            ...
                            <td><span class="status status-<?php echo $stagiaires["validation_pr"] ?>"><?php echo $stagiaires["validation_pr"] ?></span></td>
                            <td>
                               <form method="post" > 
                                
                                    <button name="view" value="<?php echo $stagiaires["IdProject"] ?>" class="action-btn view" title="View Details" onclick="openProjectModal('PRJ001')">
                                    ...
                                    <button name="valide" value="<?php echo $stagiaires["IdProject"] ?>" class="action-btn validate" title="Validate">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
                                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                            stroke-linejoin="round">
                                            <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path>
                                    ...
                                    <button name="delete" value="<?php echo $stagiaires["IdProject"] ?>" class="action-btn delete" title="Validate">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
                                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                            stroke-linejoin="round">
